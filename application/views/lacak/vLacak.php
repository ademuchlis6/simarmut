...
<head>
    ...
    <head>
        <title>. SIMARMUT (SISTEM INFORMASI MANAJEMEN SURAT MENYURAT) .</title>
    ...
    <![endif]-->
        ...
        <script src="<?php echo base_url(); ?>aset/jquery.dataTables.min.js"></script>
        <script src="<?php echo base_url(); ?>aset/dataTables.bootstrap.js"></script>
        <link href="<?php echo base_url(); ?>aset/dataTables.bootstrap.css" rel="stylesheet">
...
<body style="">
    <div class="navbar navbar-inverse navbar-fixed-top">
                ...
                <ul class="nav navbar-nav">
                    ...
                    <!-- <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="themes"><i
                                class="icon-th-list icon-white"> </i> Referensi <span class="caret"></span></a>
		...
		?>
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="themes"><i
                                class="icon-random icon-white"> </i> Catat Surat <span class="caret"></span></a>
                        <ul class="dropdown-menu" aria-labelledby="themes">
                    ...
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="themes"><i
                                class="icon-file icon-white"> </i> Buku Agenda <span class="caret"></span></a>
                        <ul class="dropdown-menu" aria-labelledby="themes">
			...
			?>
                ...
                <ul class="nav navbar-nav navbar-right">
                    <li class="dropdown">
                        <a class="dropdown-toggle" data-toggle="dropdown" href="#" id="themes"><i
                                class="icon-user icon-white"></i><?php echo $this->session->userdata('admin_level').' | '.$this->session->userdata('admin_nama') ;?>
