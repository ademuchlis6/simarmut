            ...
            <table width="100%" class="table-form">
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <a href="<?php echo base_URL(); ?>index.php/admin/surat_disposisi/<?php echo $this->uri->segment(3); ?>" tabindex="7" class="btn btn-success"><i class="icon icon-arrow-left icon-white"></i>
                            Kembali</a>
                    </td>
                </tr>
            </table>
                ...
                <tr>
                    ...
                    <td><b>
                            <select name="jenis" class="form-control" id='jenis' required>
                                ...
                                ?>
                                    <option value='<?php echo $list['waktu'] ?>'>
                                        <?php echo $list['kode'] ?>. <?php echo $list['nama'] ?>. Waktu :
