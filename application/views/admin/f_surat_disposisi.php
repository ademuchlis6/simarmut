...
<form
    action="<?php echo base_URL(); ?>index.php/admin/surat_disposisi/<?php echo $this->uri->segment(3)?>/<?php echo $act; ?>"
            ...
            <table width="100%" class="table-form">
                ...
                <tr>
                    <td colspan="2">
                        ...
                        <a href="<?php echo base_URL(); ?>index.php/admin/surat_disposisi/<?php echo $this->uri->segment(3); ?>"
