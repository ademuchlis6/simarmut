...
?>
	...
	<div class="col-lg-6">
		...
		<tr><td width="20%">Perihal</td><td><b><input type="text" name="perihal" tabindex="4" value="<?php echo $perihal; ?>" style="width: 400px" class="form-control"></b></td></tr>
	...
	<div class="col-lg-6">	
		<table width="100%" class="table-form">
			...
			<tr><td width="20%">Pengolah</td><td><b><input type="text" name="ket" tabindex="8" value="<?php echo $ket; ?>" style="width: 400px" class="form-control"></b></td></tr>				
			<tr><td width="20%">Catatan</td><td><b><textarea tabindex="11" name="catatan" required style="width: 400px; height: 50px" class="form-control"><?php echo $catatan; ?></textarea></b></td></tr>
		</table>
	</div>
